...
//Employee Management System using C++ (2020-21)
class employee {
private:
    ...
    void addNewEmployee() { 
        ...
        cout<<"\n----------------------------------------";
        cout<<"\n Enter Employee CTC(in LPA, only integer value) : ";
        cin>>ctc;
        cout<<"\n----------------------------------------";
        ...
        char ch;
        cout<<"\nEnter 's' to save the above information\n";
        cin>>ch;
...
public:
    ...
    void options(){ 
        ...
        while(true){
            ...
            cout<<"\n\t\t\t**********  EMPLOYEE MANAGEMENT SYSTEM BY ARUNAKSHA SARKAR **********";
            cout<<"\n";
            cout<<"\n\t\t\t------------------------------------------------";
            ...
            switch (choice) {
                case 0:
                    system("CLS");
                    cout<<"\n\nEMPLOYEE MANAGEMENT SYSTEM BY ARUNASKHA SARKAR \n ";
                    Sleep(10);
                    return;
